      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-1">
          ...
          <ol style="width: 220px"; class="breadcrumb float-sm-right">
            <li style="font-weight:600"><i class="nav-icon fas fa-clinic-medical"></i>&nbsp;Farmacia / Medicamentos</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card card-danger card-outline">
                ...
                <table id="tablaMedicina" class="table table-hover" style="width:100%" >

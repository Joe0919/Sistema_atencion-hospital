...
from (usuarios u inner join persona p on u.dni=p.dni) left join pers_adm e on p.idpersona = e.idpersona
where e.idpersona is null and idroles=2;";			
$npers = $conexion->prepare($consulta);
$npers->execute();
?>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
            ...
            <div id="usuar" class="row">
              <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <select style="font-weight:600;font-size:19px" class="form-control" name="UsuAd" id="UsuAd">
                      <?php while($datos = $npers->fetch(PDO::FETCH_ASSOC)) { ?>
            ...
            <div style="border: 1px solid black;padding:10px;" id="Informacion">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>DNI</label>
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="dniAd" disabled name="dniAd">
                    </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>NOMBRES</label>
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="nomAd" disabled name="nomAd">
                    </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                      ...
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="apAd" disabled name="apAd">
                    </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>APELLIDO MATERNO</label>
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="amAd" disabled name="amAd">
                    </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>CELULAR</label>
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="celAd" disabled name="celAd">
                    </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>DIRECCIÓN</label>
                      <input style="font-weight:600;font-size:18px" type="text" class="form-control" id="dirAd" disabled name="dirAd">
                    </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer justify-content-between">
          <button style="height:40px;width:120px" type="button" class="btn btn-danger" data-dismiss="modal" id="SalirAd">Cancelar </button>
          
              <button style="height: 40px;width: 120px;" type="button" class="btn btn-primary" id="SaveAd">Agregar</button>
        </div>
      </div>
    </div>
</div>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-1">
          ...
          <ol style="width: 220px"; class="breadcrumb float-sm-right">
            <li style="font-weight:600"><i class="nav-icon fas fa-user"></i>&nbsp;Personal / Administrativos</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-12">
              ...
              <div class="card card-danger card-outline">
                <div class="card-header">
                  <h3 class="card-title" style="font-weight:600; color:#084B8A">Personal Administrativos Registrados</h3>
                  <a style="float:right;width:220px;height:30px" class="btn btn-flat bg-success" data-toggle="modal" id="NuevoAd">
                    <i class="nav-icon fas fa-plus"></i>&nbsp;&nbsp;Nuevo Registro </a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  
                <table id="tablaAdmin" class="table table-hover" style="width:100%" >

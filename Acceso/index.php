<?php
    ...
    if(isset($_SESSION["idusuarios"])){
        header("Location: http://localhost/SistemaAtencion/view/Home/");
    }
...
<body>
    <div class="formulario">
        <img class="logo" src="../public/assets/img/logo.png" alt="Logo Hospital" />
        <h1>Inicio de Sesión</h1>
        <h3 style="text-align: center; font-size: 15px;font-style: italic;color: brown;">Sistema de Consulta Externa </h3>
        <?php
                if (isset($_GET["m"])){
                     switch($_GET["m"]){
                         case "1";
